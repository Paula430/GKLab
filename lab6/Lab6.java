   ...
   //[ 0.0215f, 0.1745f, 0.0215f, 1.0f, 0.07568f, 0.61424f, 0.07568f, 1.0f, 0.633f, 0.727811f, 0.633f, 1.0f, 0.6f*128]
    ...
    public void Stozek (GL2 gl2,int n,int r, int h) {
        ...
        for (int i=0;i<=n;i++)
        {
            ...
            gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[0],0);
            gl2.glVertex3d((double)(r*Math.cos(i*2*Math.PI/n)),1, (double)(r*Math.sin(i*2*Math.PI/n)));
            gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[0],6);
            gl2.glVertex3d(0, h, 0);
            i++;
            gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[0],8);
            gl2.glVertex3d((double)(r*Math.cos(i*2*Math.PI/n)),1,(double)(r*Math.sin(i*2*Math.PI/n)));
            i--;
            gl2.glEnd();
